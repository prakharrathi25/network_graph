...
// function n(e){
//     return e===(0|e)+""}function r(e){const t=document.createElement("span");return t.className="observablehq--cellname",t.textContent=e+" = ",t
// }
...
// function*x(e){
//     for(let t=0,n=e.length;t<n;++t)t in e&&(yield M(t,p(e,t),"observablehq--index"));for(const t in e)!n(t)&&d(e,t)&&(yield M(t,p(e,t),"observablehq--key"));for(const t of c(e))yield M(o(t),p(e,t),"observablehq--symbol")
// }
function* C(e) {
  let t = 0;
...
// function*N(e){
//     for(const t in b(e))yield M(t,p(e,t),"observablehq--key");for(const t of c(e))yield M(o(t),p(e,t),"observablehq--symbol");const t=v(e);t&&t!==_&&(yield q(t))
// }
// function*P(e){
//     for(const t in e)d(e,t)&&(yield M(t,p(e,t),"observablehq--key"));for(const t of c(e))yield M(o(t),p(e,t),"observablehq--symbol");const t=v(e);t&&t!==_&&(yield q(t))
// }
// function*S(e){
//     for(const[t,n]of e)yield M(t,n,"observablehq--key")
// }
// function q(e){
//     const t=document.createElement("div"),n=t.appendChild(document.createElement("span"));return t.className="observablehq--field",n.className="observablehq--prototype-key",n.textContent="  <prototype>",t.appendChild(document.createTextNode(": ")),t.appendChild(oe(e,void 0,void 0,void 0,!0)),t
// }
// function M(e, t, n) {
...
async function qe(e, t, { array: n = !1, typed: r = !1 } = {}) {
...
class FileAttachment {
  ...
  async blob() {
    return (await Se(this)).blob();
  }
  async arrayBuffer() {
    return (await Se(this)).arrayBuffer();
  }
  async text() {
    return (await Se(this)).text();
  }
  async json() {
    return (await Se(this)).json();
  }
  async stream() {
    return (await Se(this)).body;
  }
  async csv(e) {
    return qe(this, ",", e);
  }
...
var rt = Object.assign(
  function (e) {
    ...
    Object.defineProperties(this, {
      ...
      FileAttachment: { value: je(Me), writable: !0, enumerable: !0 },
      Files: { value: Ae, writable: !0, enumerable: !0 },
